...
#import "ContactsBlockViewController.h"
...
@interface ContactsBlockViewController () < UITableViewDataSource, UITableViewDelegate, ABNewPersonViewControllerDelegate, DZNEmptyDataSetDelegate, DZNEmptyDataSetSource >
...
@implementation ContactsBlockViewController
...
- (void)viewDidLoad
{
    ...
    [self setupUIScreenForContactsBlockViewController];
}
